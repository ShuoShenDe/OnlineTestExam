...
from operate.views import PaperView, PaperListView, DownloadFunView, DownAddView,\
    ...
    QuestionViewDelete, PaperCreateList, PaperCreate, PaperScoreList, PaperCreateScore,\
    PaperScore
...
urlpatterns = [
    ...
    url(r'^paperok/(?P<paper_id>.*)/$', PaperOkView.as_view(), name="paperok"),
    url(r'^paperlist/$', PaperListView.as_view(), name="paper_list"),
    url(r'^paperoklist/$', PaperListOkView.as_view(), name="paper_ok_list"),
    
    url(r'^questionlist/$', QuestionList.as_view(), name="question_list"),
    url(r'^questionadd/$', QuestionViewAdd.as_view(), name="question_add"),
 
    url(r'^questionedit/(?P<question_id>.*)/$', QuestionViewEdit.as_view(), name="question_edit"),
    
    url(r'^questiondelete/(?P<question_id>.*)/$', QuestionViewDelete.as_view(), name="question_delete"),
    
    
    url(r'^papercreatelist/$', PaperCreateList.as_view(), name="paper_create_list"),
    
    url(r'^papercreate/$', PaperCreate.as_view(), name="paper_create"),
    
    url(r'^paperscorelist/$', PaperScoreList.as_view(), name="paper_score_list"),
